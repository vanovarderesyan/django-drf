...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create categories
        system_administration = News.objects.create(name='System administration')
        seo_optimization = News.objects.create(name='SEO optimization')
        programming = News.objects.create(name='Programming')

        # Create articles
        website_article = News.objects.create(
        ...
        google_article = News.objects.create(
        ...
        programming_article = News.objects.create(
        ...
        ubuntu_article = News.objects.create(
        ...
        django_article = News.objects.create(
